...
export default function PilgrimsPage() {
  return (
    <div>
      <div className="mb-4">
        <h1 className="font-display text-3xl">Зиератчилар</h1>
      ...
      <Card className="text-ink-soft">
        API-эндпоинты для раздела «Зиератчилар» уже работают. UI будет наполняться по приоритетам команды продукта.
      </Card>
    </div>
  );
}
